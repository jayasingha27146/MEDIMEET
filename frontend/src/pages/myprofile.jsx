  ...
  return (
    <div className='max-w-lg flex flex-col  gap-6 text-sm'>
        ...
        <div className='mt-10'>
          {
            isEdit 
            ? <button className='border border-primary px-6 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={() => setIsEdit(false)}>Save Your Details</button>
